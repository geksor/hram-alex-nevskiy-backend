...
/* @var $searchModel common\models\ClergySocNetSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Социальные сети';
$this->params['breadcrumbs'][] = ['label' => 'Духовенство', 'url' => ['clergy/index']];
$this->params['breadcrumbs'][] = ['label' => \common\models\Clergy::findOne($searchModel->clergy_id)->name, 'url' => ['clergy/view', 'id' => $searchModel->clergy_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="clergy-soc-net-index">
    ...
    <div class="box box-primary">
        <div class="box-body">
            ...
            <p>
                <?= Html::a('<i class="fa fa-reply" aria-hidden="true"></i>', ['clergy/view', 'id' => $searchModel->clergy_id], ['class' => 'btn btn-default']) ?>
                <?= Html::a('Создать запись', ['create', 'id' => $searchModel->clergy_id], ['class' => 'btn btn-success']) ?>
            </p>
