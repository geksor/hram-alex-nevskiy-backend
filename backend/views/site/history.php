...
<div class="contact-params">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="row" style="display: flex; align-items: center;">
                        <? if ($model->image) {?>
                            ...
                            <div class="col-xs-6">
                                <?= Html::a('Изменить', ['image-history'], ['class' => 'btn btn-warning']) ?>
                            </div>
                        <?}else{?>
                            <div class="col-xs-6">
                                <?= Html::a('Загрузить', ['image-history'], ['class' => 'btn btn-success']) ?>
                            </div>
                        <?}?>
                    </div>
                </div>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <?php } else { ?>
                <?= Html::a('Создать', ['create-gallery-history'], ['class' => 'btn btn-success']) ?>
            <?}?>
        </div>
    </div>
