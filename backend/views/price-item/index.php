...
$this->params['breadcrumbs'][] = ['label' => \common\models\Price::findOne($searchModel->price_id)->title, 'url' => ['price/view', 'id' => $searchModel->price_id]];
...
<div class="price-item-index">
    ...
    <div class="box box-primary">
        <div class="box-body">
            ...
            <p>
                <?= Html::a('<i class="fa fa-reply" aria-hidden="true"></i>', ['price/view', 'id' => $searchModel->price_id], ['class' => 'btn btn-default']) ?>
                <?= Html::a('Создать запись', ['create', 'id' => $searchModel->price_id], ['class' => 'btn btn-success']) ?>
            </p>
